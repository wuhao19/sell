    ...
    <ul class="nav sidebar-nav">
        ...
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/sell/seller/product/addProduct">新增</a></li>
            </ul>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/sell/seller/category/addCategory">新增</a></li>
            </ul>
        </li>

        <li>
            <a href="/sell/seller/index/logout"><i class="fa fa-fw fa-list-alt"></i> 登出</a>
        </li>
    </ul>
</nav>